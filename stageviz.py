...
ax_setpointTB = TextBox(ax_setpoint, 'Setpoint:', initial='0, 450, 0, 0, 0')
...
def update(setpoint='0, 450, 0, 0, 0', TPx=0, TPy=0):
    ...
    T0TP = get_transformation_TP(stage_pos[0], stage_pos[1], stage_pos[2], stage_pos[3], stage_pos[4], TPx, TPy)
...
def reset(event):
    ...
    slider_x.reset()
    slider_y.reset()
    ax_setpointTB.set_val('0, 450, 0, 0, 0')
    return
